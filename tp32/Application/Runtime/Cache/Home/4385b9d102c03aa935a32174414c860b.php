...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/tp32/Public/date/shijian.css"/>
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<form action="<?php echo U('msg/query');?>" method="post">
		查询留言:<input type="text" name="time1" id="input1">~
		<input type="text" name="time2" id="input2">
	...
	<script type="text/javascript" src="/tp32/Public/date/jquery_shijian.js"></script>
